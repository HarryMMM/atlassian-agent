...
public class KeyTransformer implements ClassFileTransformer {
    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws IllegalClassFormatException {
        if (className == null) {
            ...
            return className.equals("java/security/spec/EncodedKeySpec") ? this.handleKeySpec() : classfileBuffer;
        }
    }
    ...
    private byte[] handleKeySpec() throws IllegalClassFormatException {
        try {
            ...
            CtClass cc = cp.get("java/security/spec/EncodedKeySpec".replace('/', '.'));
            ...
            try {
                ...
                try {
                    ...
                    ClassNotFoundException e1 = var6;
